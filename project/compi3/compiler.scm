                     ...
                     (lambda (is-bound? e)
                       ((compose-patterns
                         ...
                         (pattern-rule
                          `(applic ,(? 'func) ,(? 'exprs list?))
                          (lambda (func exprs)
                            (let ((results `(,(run func) ,@(map run exprs))))
